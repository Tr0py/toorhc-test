...
#define ISO_FTABLE __attribute__((section("iv_functable_"STR(ISONAME))))
#define ISO_STUB(name) \
void __attribute__((section("iv_stub_"STR(name)"_stub"))) __attribute__((aligned(4096))) CONCAT2(_xcall_stub_, name)();
ISO_STUB(ISONAME)
